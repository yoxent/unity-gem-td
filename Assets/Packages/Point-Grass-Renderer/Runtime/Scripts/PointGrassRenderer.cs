        ...
        private bool GetMeshData(out MeshData meshData) {
            ...
            switch (distSource) {
                case DistributionSource.Mesh:
                    ...
                    Color[] meshColours = baseMesh.colors;
                    if (meshColours == null || meshColours.Length != baseMesh.vertexCount) { meshColours = null; }
                    // Create the mesh data
                    meshData = new MeshData(baseMesh.vertices, baseMesh.normals, baseMesh.uv, meshColours, baseMesh.triangles, meshAttributes);
                    return true;
                ...
                case DistributionSource.MeshFilter:
                    ...
                    if (filter != null) {
                        ...
                        if (baseMesh != null) {
                            ...
                            Color[] filterColours = baseMesh.colors;
                            if (filterColours == null || filterColours.Length != baseMesh.vertexCount) { filterColours = null; }
                            // Create the mesh data
                            meshData = new MeshData(baseMesh.vertices, baseMesh.normals, baseMesh.uv, filterColours, baseMesh.triangles, filterAttributes);
                            return true;
                        }
                    }
                    break;
