...
{
    /// <summary>
    /// Bloons-style placement ghost: low-opacity tower mesh + range disc.
    /// Valid = green tint, invalid = red tint.
    /// </summary>
    public sealed class PlacementGhostView : MonoBehaviour
    {
        ...
        public void EnsureBuilt(TowerView towerPrefab)
        {
        ...
        public void SetRange(float rangeWorld)
        {
            ...
            _rangeDisc.localScale = new Vector3(diameter, 0.02f, diameter);
        }
