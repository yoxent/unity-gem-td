...
namespace GemTD.Gameplay.Run
{
    ...
    public sealed class RunStateDebugHud : MonoBehaviour
    {
        void OnGUI()
        {
            ...
            var label = $"State: {root.States.Current}   |  HUD Start Wave / click + / place   |  F5 debug advance   |  F6 fill bag   |  WASD pan  MMB drag  scroll zoom  Q/E rotate  R targeting  Ctrl+C/V copy-paste";
